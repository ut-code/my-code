---
id: typescript-classes-param-props
title: 従来の書き方と省略記法（パラメータプロパティ）
level: 3
question:
  - コンストラクタの引数に修飾子をつける（パラメータプロパティ）と、通常の書き方とで何が違いますか？
  - _age のようにプロパティ名の前にアンダースコアをつけるのはなぜですか？
  - privateなプロパティにクラスの外からアクセスしようとすると、どのようなエラーメッセージが出ますか？
  - TypeScriptの private はコンパイル時のチェックだけ、というのはどういう意味ですか？
  - 'JavaScript標準の # (プライベートフィールド) とは、TypeScriptの private と何が違いますか？'
---

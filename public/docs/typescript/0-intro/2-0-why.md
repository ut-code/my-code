---
id: typescript-intro-why
title: なぜTypeScriptか？
level: 2
question:
  - 型安全性によって具体的にどのような種類のバグを防げますか？
  - '`undefined`のプロパティを読み取ろうとするミスとは、どういう状況で発生するのですか？'
  - エディタサポートの「正確なコード補完」はJavaScriptの時と何が違うのですか？
  - リファクタリングの容易さとは、具体的にどんな時に便利さを感じるのですか？
---

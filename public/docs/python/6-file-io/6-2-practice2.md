---
id: python-file-io-practice2
title: '練習問題2: 売上データのCSV集計'
level: 3
question:
  - '`newline=''''` を指定せずにCSVファイルを書き込んだ場合、具体的にどのような問題が起こるか試してみたいのですが、どうすれば確認できますか？'
  - '`csv` モジュールで読み込んだ文字列を `int()` に変換し忘れた場合、どのようなエラーが発生しますか？'
  - ヘッダー行を無視する方法として、`next(reader)` 以外にどのような選択肢がありますか？
---

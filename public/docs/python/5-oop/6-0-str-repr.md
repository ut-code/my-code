---
id: python-oop-str-repr
title: 基本的なマジックメソッド (__str__, __repr__)
level: 2
question:
  - マジックメソッドは他にどのようなものがありますか。
  - __str__と__repr__の具体的な使い分けの例をもっと知りたいです。
  - __str__だけを定義して__repr__を定義しないとどうなりますか。
  - >-
    __repr__の出力がDog(name='{self.name}',
    age={self.age})のようにシングルクォートで囲まれているのはなぜですか。
  - repr()関数はどのような場面で使うのですか。
---

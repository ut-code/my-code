---
id: ruby-blocks-iterators-for
title: for ループとの比較
level: 2
question:
  - Rubyの for ループが内部的に each メソッドを呼び出しているとは、具体的にどういうことですか？
  - for ループを使わない方が良い理由として、パフォーマンスの差などはありますか？
  - ほとんど使われないのなら、なぜ for 構文はRubyに残されているのですか？
  - for ループを使うべき例外的なケースはありますか？
---

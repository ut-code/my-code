...
level: 2
question:
  - クラス変数とインスタンス変数の最も大きな違いは何ですか？
  - クラス全体で共有されるとは具体的にどういうことですか？
  - クラス変数を継承した場合に「意図しない動作の原因になる」具体的な例を教えてください。
  - def self.メソッド名と定義するself.とは何ですか？
  - クラスメソッドからインスタンス変数にアクセスできないのはなぜですか？
  - ファクトリメソッドとは何ですか？具体例を教えてください。
  - c1.total_countがNoMethodErrorになるのはなぜですか？
---

---
id: rust-modules-pkg-crate-module
title: パッケージ、クレート、モジュール
level: 2
question:
  - パッケージ、クレート、モジュールは具体的にどう違うのですか？
  - Cargo.tomlファイルは具体的に何をするものですか？
  - バイナリクレートとライブラリクレートはどのように使い分けるのですか？
  - src/main.rsとsrc/lib.rsは、それぞれどのようなファイルですか？
  - モジュールはなぜ必要なのでしょうか？
---

---
id: rust-enums-pattern-why-safe
title: なぜこれが安全なのか？
level: 3
question:
  - Option<i8> と i8 が足し算できないのはなぜですか？
  - コンパイラレベルで禁止されると具体的にどうなりますか？
  - 「値を取り出すには明示的な処理が必要」とありますが、どのような処理が必要ですか？
  - Noneの場合は型推論できないため、明示的に型を指定する必要があるのはなぜですか？
---

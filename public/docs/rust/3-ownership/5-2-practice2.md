---
id: rust-ownership-practice2
title: '練習問題 2: 所有権のリレー'
level: 3
question:
  - '`process_string`関数を修正して、受け取った文字列の所有権を呼び出し元に返すには、具体的にどのようなコードを追加・変更すれば良いですか？'
  - '`main`関数で`process_string`を呼び出す部分も変更が必要だと思いますが、どのように修正すれば良いですか？'
---

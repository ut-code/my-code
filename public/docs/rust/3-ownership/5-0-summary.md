---
id: rust-ownership-summary
title: この章のまとめ
level: 2
question:
  - Rustが実行時のガベージコレクションによる停止を避けられるというのは、どのようなメリットがあるのですか？
  - ダングリングポインタや二重解放のバグをコンパイル時に完全に防ぐ仕組みは、この所有権ルールやムーブセマンティクスによってどのように実現されているのですか？
  - 「関数に値を渡すたびに所有権がなくなってしまい、使えなくなるのは不便」とありますが、この問題を解決する具体的な方法は次章の「借用」で学ぶのですね？
---

---
id: javascript-intro-comparison
title: 他言語との比較
level: 2
question:
  - 「動的型付け (弱い型付け)」とは他の動的型付け言語と何が違うのですか？
  - 「シングルスレッド + イベントループ」は他の言語のマルチスレッドとどう異なるのですか？
  - 「プロトタイプベース」のオブジェクト指向とはクラスベースと具体的にどう違うのですか？
  - JavaScriptのclass構文が「シンタックスシュガー」とはどういう意味ですか？
  - なぜJavaScriptではインデントではなく波括弧を使うのですか？
---

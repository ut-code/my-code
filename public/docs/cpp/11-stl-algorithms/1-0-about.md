---
id: cpp-stl-algorithms-about
title: イテレータ：コンテナとアルゴリズムを繋ぐ架け橋
level: 2
question:
  - イテレータは通常のポインタと何が違うのですか？
  - end()が最後の要素の次を指すのはなぜですか？
  - 半開区間 [begin, end) というのがよくわかりません。なぜendの要素を含まないのですか？
  - autoというキーワードは何ですか？
  - '*it と it は何が違うのですか？'
  - 範囲ベースforループの方が簡単に書けるように見えますが、イテレータを直接使うメリットは何ですか？
  - std::vector以外のstd::listやstd::mapでもイテレータは使えるのですか？
---

---
id: cpp-templates-summary
title: この章のまとめ
level: 2
question:
  - ジェネリックプログラミングとはどのような考え方ですか
  - 関数テンプレートのテンプレート引数推論には何かデメリットもありますか
  - クラステンプレートで型を明示的に指定し忘れたらどうなりますか
  - テンプレートを使いこなすことで、具体的にコードの再利用性がどのように向上するのですか
  - 堅牢なプログラムとはどのようなプログラムを指しますか
---
